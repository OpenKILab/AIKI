...
def main():
    ...
    if dataset_name == 'livecode':
        data_path = f'/mnt/petrelfs/leishanzhe/repo/Search-o1/data/LiveCodeBench/{split}.json'
    elif dataset_name in ['math500', 'gpqa', 'aime', 'amc']:
        data_path = f'/mnt/petrelfs/leishanzhe/repo/Search-o1/data/{dataset_name.upper()}/{split}.json'
    else:
        data_path = f'/mnt/petrelfs/leishanzhe/repo/Search-o1/data/QA_Datasets/{dataset_name}.json'
    ...
    cache_dir = '/mnt/petrelfs/leishanzhe/repo/Search-o1/cache'
